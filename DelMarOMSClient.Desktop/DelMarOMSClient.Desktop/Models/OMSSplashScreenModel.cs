...
namespace DelMarOMSClient.Desktop.Models
{
    public class OMSSplashScreenModel : INotifyPropertyChanged
    {
        public OMSSplashScreenModel()
        {
            Message = "Connecting To OMS.  Please wait...";
        }
